                        ...
                        @php
                            ...
                            $targetVariant = $product->variants->first(
                                function ($v) use ($option, $variant, $property) {
                                    ...
                                    // из-за того, что после первой смены ЦВЕТА пропадает возможность ЕГО ПОВТОРНОЙ! смены, пришлось убрать проверку на совпадение 
                                    // остальных опций, ТО ЕСТЬ пока не фиксируем остальные оси! ТИПА при смене цвета → ищем любой вариант с этим цветом
                                    // А! при смене памяти → ищем любой вариант с этой памятью
