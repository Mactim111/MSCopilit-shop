{{-- Фильтр-переключатель: «Есть NFC», «Поддержка беспроводной зарядки».
     URL: ?f[nfc][]=yes
...
<div class="w-[316px] border-b border-dashed border-gray-300 py-[14px]">
    <label for="f_toggle_{{ $property->slug }}"
        ...
        <span class="text-[15px] font-bold text-[#231F20] group-hover:text-[#DC092E] transition-colors">
            {{ $property->title }}
        </span>

        {{-- CSS-переключатель в стиле проекта --}}
