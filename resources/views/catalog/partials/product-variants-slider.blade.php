...
{{-- у 5 ЭЛЕМЕНТ под ВСЕМИ слайдерами c карточками вариантов товаров стоит mb-[70px] НО! оно! так на странице не выглядит! поэтому у себя МОЖЕТ СТОИТ применить mb-[35px] ?!! --}}
                            ...
                            <div class="grid grid-cols-2 gap-2 items-start">
                                ...
                                <div class="text-right">
                                    <form action="{{ route('cart.add', $variant) }}" method="POST"
                                          ...
                                          class="mx-auto js-cart-add-form">
                                        @csrf
