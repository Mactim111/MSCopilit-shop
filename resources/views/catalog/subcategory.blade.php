...
@endphp
    ...
    <div class="max-w-[1500px] mx-auto flex mb-[70px]">
        ...
        <main class="w-full max-w-[1152px] flex flex-col">
            ...
            {{-- Ниже подключена РАБОЧАЯ версия компонента с выборкой тегов из Сервиса и Контроллера от Claude --}}
            <x-subcategory-tags :subcategoryTags="$subcategoryTags" />
            {{-- Ниже подключена ТЕСТОВАЯ версия компонента БЕЗ выборки тегов из Сервиса и Контроллера- чисто ВИЗУАЛ! - от aistudio.google.com --}}
            {{-- <x-subcategory-tags-aistudio /> --}}
